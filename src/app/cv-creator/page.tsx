...
export default function CVCreatorPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-700">Ładowanie kreatora CV...</h2>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Aby utworzyć CV, musisz być zalogowany.</p>
          <button
  ...
  // Render the CV Creator component
  return <CVCreator />;
}